...
exports.editRentSchema = exports.createRentSchema = exports.getAllRentSchema = void 0;
exports.getAllRentSchema = {
    skip: {
        in: ["query"],
        optional: true,
        isNumeric: true,
    ...
    categories: {
        ...
        custom: {
            ...
            options: function (value) {
                return value.every(function (v) { return v.match(/^[0-9a-fA-F]{24}$/); });
            },
        },
    },
    capacities: {
        ...
        custom: {
            ...
            options: function (value) {
                return value.every(function (v) { return !isNaN(parseInt(v)); });
            },
        },
    },
    maxPrice: {
