...
var getById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, location_2, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, location_1.default.findById(id)];
            case 1:
                location_2 = _a.sent();
                if (!location_2) {
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var title, location_3, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                title = req.matchedData.title;
                return [4 /*yield*/, location_1.default.create({ title: title })];
            case 1:
                location_3 = _a.sent();
                res.status(201).json({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = req.params.id;
                title = req.matchedData.title;
                return [4 /*yield*/, location_1.default.findByIdAndUpdate(id, { title: title })];
            case 1:
                location_4 = _a.sent();
                if (!location_4) {
                    res.status(404).json({ message: "Location not found!" });
...
var remove = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, hasAnyRent, location_5, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
